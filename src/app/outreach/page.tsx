    ...
    <div className="pt-32 pb-24 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {(!events || events.length === 0) ? (
          <EmptyState 
            title="Outreach events in planning" 
            message="We're currently organizing our next set of community outreach programs. Check back soon for updates on where we've been and where we're going next."
